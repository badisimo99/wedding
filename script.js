...
const MELODY = [
  ...
  { note: "D4",  beat: 0.5, duration: 0.4 },
  { note: "E4",  beat: 1.0, duration: 0.4 },
  { note: "F#4", beat: 1.5, duration: 0.4 },
  { note: "D4",  beat: 2.0, duration: 0.4 },
  { note: "F#4", beat: 2.5, duration: 0.8 },
  { note: "F#4", beat: 3.5, duration: 0.4 },
  { note: "G4",  beat: 4.0, duration: 0.4 },
  { note: "A4",  beat: 4.5, duration: 0.4 },
  { note: "B4",  beat: 5.0, duration: 0.4 },
  { note: "G4",  beat: 5.5, duration: 0.4 },
  { note: "F#4", beat: 6.0, duration: 0.4 },
  { note: "D4",  beat: 6.5, duration: 1.2 },

  // Line 2: Goin' to the chapel and we're gonna get married
  { note: "E4",  beat: 8.0, duration: 0.4 },
  { note: "E4",  beat: 8.5, duration: 0.4 },
  { note: "F#4", beat: 9.0, duration: 0.4 },
  { note: "G4",  beat: 9.5, duration: 0.4 },
  { note: "E4",  beat: 10.0, duration: 0.4 },
  { note: "G4",  beat: 10.5, duration: 0.8 },
  { note: "G4",  beat: 11.5, duration: 0.4 },
  { note: "A4",  beat: 12.0, duration: 0.4 },
  { note: "B4",  beat: 12.5, duration: 0.4 },
  { note: "C#5", beat: 13.0, duration: 0.4 },
  { note: "A4",  beat: 13.5, duration: 0.4 },
  { note: "G4",  beat: 14.0, duration: 0.4 },
  { note: "E4",  beat: 14.5, duration: 1.2 },

  // Line 3: Gee, I really love you and we're gonna get married
  { note: "A4",  beat: 16.0, duration: 0.4 },
  { note: "A4",  beat: 16.5, duration: 0.4 },
  { note: "F#4", beat: 17.0, duration: 0.4 },
  { note: "A4",  beat: 17.5, duration: 0.4 },
  { note: "F#4", beat: 18.0, duration: 0.4 },
  { note: "D4",  beat: 18.5, duration: 0.8 },
  { note: "F#4", beat: 19.5, duration: 0.4 },
  { note: "G4",  beat: 20.0, duration: 0.4 },
  { note: "A4",  beat: 20.5, duration: 0.4 },
  { note: "B4",  beat: 21.0, duration: 0.4 },
  { note: "G4",  beat: 21.5, duration: 0.4 },
  { note: "F#4", beat: 22.0, duration: 0.4 },
  { note: "D4",  beat: 22.5, duration: 1.2 },

  // Line 4: Goin' to the chapel of love
  { note: "D4",  beat: 24.0, duration: 0.4 },
  { note: "D4",  beat: 24.5, duration: 0.4 },
  { note: "E4",  beat: 25.0, duration: 0.4 },
  { note: "F#4", beat: 25.5, duration: 0.4 },
  { note: "D4",  beat: 26.0, duration: 0.4 },
